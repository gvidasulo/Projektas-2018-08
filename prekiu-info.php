...
$preke1ParametraiD = ['3GB', 'Amlogic S912 2.0GHz, Octa Core ', '32G ROM ', 'Integruotas'];

$preke2ParametraiK = ['RAM', 'Procesorius', 'Atmintis', 'wifi'];
$preke2ParametraiD = ['2GB', 'Amlogic S912 2.0GHz, Octa Core ', '16G ROM', 'Integruotas'];

$preke3ParametraiK = ['Modelis', 'External Interface', 'Supporting Max. Hard Drive Capacity', 'Read Speed'];
$preke3ParametraiD = ['850 PRO', 'SATA 3 ', '256GB', '550MB/s'];

$preke4ParametraiK = ['RAM', 'Procesorius', 'Atmintis', 'wifi'];
$preke4ParametraiD = ['2GB', 'Intel Atom X5-Z8350', '32G ROM', 'Integruotas'];
