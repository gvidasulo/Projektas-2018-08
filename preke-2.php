                ...
                <div class="col-md">
                    <div class="row">
                      ...
                      <div class="col-md-6 aukstis-400 prekiu-tekstas">
                          ...
                          $preke2 = getPreke(2);
                          ?>
                          <h2><?php echo $preke2['name']; ?></h2>
                          <h4>Kaina: <?php echo $preke2['price']; ?> &euro;</h4>
                          <h6>Kiekis: <?php echo $preke2['kiekis']; ?></h6>
                          <p><?php echo $preke2Aprasymas[0]; ?></p>
                          <a href="apmokejimas.php?apmokejimas=<?php echo $preke2['id']; ?>">
